...
readonly retrobar_gx4000_input_player1_turbo_btn="x"
readonly retrobar_gx4000_input_turbo_default_button="a"
readonly retrobar_jaguar_input_player1_turbo_btn="x"
...
readonly retrobed_gx4000_input_player1_turbo_btn="x"
readonly retrobed_gx4000_input_turbo_default_button="a"
readonly retrobed_jaguar_input_player1_turbo_btn="x"
...
readonly retroboy_gx4000_input_player1_turbo_btn="x"
readonly retroboy_gx4000_input_turbo_default_button="a"
readonly retroboy_jaguar_input_player1_turbo_btn="x"
...
readonly -a y_turbo_rom_cfgs=(
	...
	"neogeo;s1945p"
	"neogeo;sonicwi2"
	"pc;CHAMP Galagon (1997)(CHAMProgramming)"
	"pc;Duke Nukem II [SWR] (1993)(Apogee Software, Ltd.) [Action]"
	"pc;Jazz Jackrabbit (1992)(Epic Megagames)"
...
readonly -A rom_cfgs=(
	...
	["pc;CHAMP Galagon (1997)(CHAMProgramming);input_player1_turbo_btn"]="x"
	["pc;Jazz Jackrabbit (1992)(Epic Megagames);input_turbo_default_button"]="a"
	["pc88;Melt Down (Kaiteiban) {4MHz};input_player1_turbo_btn"]="x"
	["pc88;Melt Down (Kaiteiban) {4MHz};input_turbo_default_button"]="y"
